...
public class Collective1Main {
	...
	p1.setCost(3); // inventato
	p1.setWeightTravelTime(0.4);
	p1.setWeightCost(0.2);
	...
	p2.setId(32);
	p2.setTravel_time(20); // inventato
	p2.setCost(10); // inventato
	p2.setWeightTravelTime(0.2);
	p2.setWeightCost(0.3);
	p2.setMaxTravelTime(30);
	p2.setMaxCost(5);

	CollectiveAdaptationRole p3 = new CollectiveAdaptationRole();
	p3.setRole("RoutePassenger_36");
	p3.setId(36);
	p3.setTravel_time(10); // inventato
	p3.setCost(3); // inventato
	p3.setWeightTravelTime(0.3);
	p3.setWeightCost(0.2);
	p3.setMaxTravelTime(30);
	p3.setMaxCost(5);
	...
	CollectiveAdaptationProblem cap = new CollectiveAdaptationProblem("CAP_1", ensembles, "IntenseTraffic",
